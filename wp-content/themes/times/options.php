    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            <?php if ($screenshot) : ?>
                ...
                <div>
                    <ul class="theme-info">
                        <li><?php printf(__('By %s', 'times'), $this->theme->display('Author')); ?></li>
                        <li><?php printf(__('Version %s', 'times'), $this->theme->display('Version')); ?></li>
                        <li><?php echo '<strong>' . __('Tags', 'times') . ':</strong> '; ?><?php printf($this->theme->display('Tags')); ?></li>
                    </ul>
                    <p class="theme-description"><?php echo $this->theme->display('Description'); ?></p>
            <?php
            if ($this->theme->parent()) {
                printf(' <p class="howto">' . __('This <a href="%1$s">child theme</a> requires its parent theme, %2$s.') . '</p>', __('http://codex.wordpress.org/Child_Themes', 'times'), $this->theme->parent()->display('Name'));
            }
            ?>
            ...
            if (file_exists(dirname(__FILE__) . '/info-html.html')) {
                ...
                'fields'    => array(
                	array(
                        ...
                        'desc'      => __('Enabling Logo will Disable the default title and description.', 'times'),
                        'subtitle'  => __('Upload any Image. It will not be resized Automatically.', 'times'),
                        'default'   => '',
                    ),
                    array(
	                        'id'    => 'pro-warning-1',
             ...
             $this->sections[] = array(
                ...
                'fields'    => array(
                		array(
	                        ...
	                        'type'      => 'checkbox',
	                        'title'     => __('Enable Carousel on Home', 'times'),
	                        'subtitle'  => __('This will enable carousel on both the static front page, and homepage(blog).', 'times'),
	                    ...
	                    array(
	                        ...
	                        'desc'          => __('Set the Transition Speed at which Slider switch from One Slide to Another.', 'times'),
	                        'default'       => 6,
	                        'min'           => 3,
	                        'step'          => 1,
	                        'max'           => 12,
	                	...
	                	array(
	                        ...
	                        'data'      => 'categories',
	                        'multi'     => true,
	                        'title'     => __('Categories', 'times'),
	                        'subtitle'  => __('Select all the Categories from which the Posts should be Fetched.', 'times'),
	                    ),
             ...
             $this->sections[] = array(
                ...
                'fields'    => array(
                		array(
	                        ...
	                        'type'      => 'checkbox',
	                        'title'     => __('Enable Social Icons', 'times'),
	                        'subtitle'  => __('This will enable social icons in the top of right sidebar', 'times'),
	                        //'options' => array('on', 'off'),
	                        'default'   => false,
                        ),
                        array(
